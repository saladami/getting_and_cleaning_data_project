...
* The run_analysis.R script performs the following steps to clean the data:   
 ...
 4. Read the features.txt file from the "/data" folder and store the data in a variable called *features*. We extract only measurements pertaining to mean and standard deviation. This results in a list of 66 indices. We then subset *joinData* to obtain these 66 columns.  
